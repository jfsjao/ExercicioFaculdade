...
function validaform (e){
    ...
    const spandate = form.data.nextElementSibling;
    ...
    if(!formulario){
        ...
        Linome.append("nome: "+form.NomeCompleto.value);
        olhtml.append(Linome);
        
        const Licpf = document.createElement("li");
        Licpf.append("CPF: "+form.cpf.value
        );
        olhtml.append(Licpf); 
        
        const Liemail = document.createElement("li");
        Liemail.append("email: "+form.email.value);
        olhtml.append(Liemail);

        document.getElementById('cpf').style.borderColor = 'green';
        document.getElementById('NomeCompleto').style.borderColor = 'green';
        document.getElementById('email').style.borderColor = 'green';
        document.getElementById('cursosbox').style.borderColor = 'green';
    }
}