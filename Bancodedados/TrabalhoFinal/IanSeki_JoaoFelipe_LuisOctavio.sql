...
SELECT nomeCli,nomeL FROM Cliente JOIN Cadastra ON Cliente.CPF = Cadastra.fk_Cliente_CPF JOIN Livraria ON Cadastra.fk_Livraria_cod_Loja = Livraria.cod_Loja WHERE Livraria.cidadeL = 'Cidade 1' AND Cliente.bairroCli='Bairro 1'
